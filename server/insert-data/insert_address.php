...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Data from form
  $address_num = mysqli_real_escape_string($conn, $_POST["addressNumber"]);
  $address = mysqli_real_escape_string($conn, $_POST["address"]);
  $city = mysqli_real_escape_string($conn, $_POST["city"]);
  $zipCode = mysqli_real_escape_string($conn, $_POST["zipCode"]);

  // INSERT INTO ADDRESS
  $sql = "INSERT INTO Address(Address_number, Address, City, Zip_code) 
  VALUES ($address_num, '$address', '$city', $zipCode)";
